...
- **RAG cold SQL (2026-09-13, 인덱스·힌트 적용)**: 기관명 LIKE 콜드 I/O 가 원인. 공고 인덱스·낙찰 힌트로 q08 8초대, 금액 집계 잔여 ([rag_coldsql_root_cause_20260913.md](../analysis/rag_coldsql_root_cause_20260913.md)).
