...
| **G2** | 크로스 플랫폼 | **보류 (회귀 조사 중)** | **현 HEAD CI 는 RED 입니다.** run `33494985187`(`a09b73d`)에서 Windows py3.11 과 MySQL ngram 두 job 이 실패했고 직전 2회도 같습니다. 종전 근거였던 2026-08-26 run `32930156938`(`5f8174a`)은 **구형 SHA** 이므로 현 상태의 증거가 아닙니다. Windows 실기 미수행과는 **별개 문제**입니다 |
