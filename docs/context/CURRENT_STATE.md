...
2. **프론트엔드 CDN 로컬화**: HTMX 는 2026-08-25 기각하고 ADR 을 SSR + Jinja2 + jQuery 로 개정했습니다. 남은 것은 `base.html` 이 외부 호스트 7곳에서 렌더링 자산을 받는 문제이며 G2 재현성에 걸립니다.
