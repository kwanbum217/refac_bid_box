...
- **RAG cold SQL (2026-09-13, 인덱스·힌트 적용)**: 기관명 LIKE 콜드 I/O 가 원인. 공고·낙찰 커버링 인덱스와 힌트로 q08 6초대, q03 7초대. 임시 테이블 상한 128MB 로 q08 공고명 집계 디스크 전환 제거 ([rag_coldsql_root_cause_20260913.md](../analysis/rag_coldsql_root_cause_20260913.md)).
...
- 현재 잔여 과업: [session_20260913_rag_coldsql_and_ci_recovery.md](../handoff/session_20260913_rag_coldsql_and_ci_recovery.md) (6장)
