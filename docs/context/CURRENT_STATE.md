...
- **RAG cold SQL (2026-09-13, 공고 인덱스 적용)**: 기관명 LIKE 콜드 I/O 가 원인. 공고 커버링 인덱스로 q31 1초대, bid_results 쪽 잔여 ([rag_coldsql_root_cause_20260913.md](../analysis/rag_coldsql_root_cause_20260913.md)).
