...
### 3.5 기한부 예외 현황 (2026-09-21 종결)

nanoid 취약점 예외는 커밋 `d68078a7`(fix: nanoid 보안 취약점 해결 및 공급망 위생 개선)에서 상류 수정 버전을 적용하며 해소되어 `.github/vulnerability-allowlist.yml` 에서 제거되었습니다. 현재 기한부 예외는 chromadb 3건뿐이며 셋 다 `expires_on` 이 2026-12-31 입니다. 상류 수정 버전은 만료 30일 전인 2026-12-01 에 재확인합니다.
