...
### 2026-08-07 | 용역 탐색 | quantile 아래 하이퍼파라미터 재탐색 (홀드아웃까지)
...
- **승격 없음**: 운영 경로 쌍대 검정을 하지 않았습니다. 이 축에서 홀드아웃 이득이 운영에서 뒤집힌 전례가 두 번이며 둘 다 이번보다 3배 이상 큰 이득이었습니다. Servc 서빙은 `v_20260807_043210_535` 그대로입니다
- **문서**: `docs/design/servc_hyperparam_quantile_20260807.md` 신설, 인수인계 2장을 재개 지점으로 갱신, 스킬에 채택 대기 후보와 시드 산포 판정 기준을 추가했습니다
