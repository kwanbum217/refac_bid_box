...
1. **치명적 런타임 퇴행 부재 (No Critical Regression)**:
   ...
   - c2 6,000개 표본(c2/c4 A/B 전체 12,000개 표본) 전체에서 >50ms 및 >100ms 지연이 단 1건도 발생하지 않았습니다. 즉 해당 6,000 표본의 실험 조건에서는 꼬리 지연 파탄이나 GC 블로킹의 증거가 관측되지 않았습니다. 유한 표본이므로 결함의 부재를 증명한 것은 아닙니다.
