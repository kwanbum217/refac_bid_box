...
> [!WARNING] 폐기 안내 (2026-08-25)
> 본 계획은 2026-08-25 기각되어 이행하지 않으며, 정본은 [`FRONTEND_DECISION.md`](FRONTEND_DECISION.md)입니다.
> 기각 근거: "목표 아키텍처의 1차 UI 를 **SSR + Jinja2 (+ jQuery)** 로 개정하고 HTMX 도입을 기각합니다. 구현을 목표에 맞추는 대신 목표를 구현에 맞추는 선택입니다." (본문은 이력 보존을 위해 유지합니다.)
