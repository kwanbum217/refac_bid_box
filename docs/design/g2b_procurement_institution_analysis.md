...
| 1 | `src/ml/dataset.py` 에 정제 규칙 추가 + 신규 필드 20종 조인 | 0 | 대기 |
| 2 | `sucsfbidLwltRate`, `prearngPrceDcsnMthdNm`, `sucsfbidMthdNm`, `srvceDivNm` 컬럼 승격 + 백필 | 1 | 대기 |
| 3 | 8.2 절 신규 특징을 `src/ml/features.py` 단일 함수에 추가 | 2 | 대기 |
