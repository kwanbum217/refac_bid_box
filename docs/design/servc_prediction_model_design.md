...
4.9 절의 `presmptPrce` 가용성 검증(V3)에 더해, 아래가 모두 끝나야 착수합니다.

| 번호 | 항목 |
| --- | --- |
| V1 | 2026-05-26 이후 표본 수와 하한율 분포 |
| V2 | 하한율 88.000(171,390건) 의 제도적 근거 |
| V3 | 공고 시점 `presmptPrce` 의 의미 |
| V4 | `bidwinnrDcsnMthdNm` 분포 (분리 모델 규모 결정) |
| V5 | 협상 계약 건의 낙찰률 분산 |
| V6 | 기초금액 필드 확보 가능성 |

세부는 제도 분석서 6.4 절을 따릅니다.
