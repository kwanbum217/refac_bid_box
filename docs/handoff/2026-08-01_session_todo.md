...
1. **ChatAutomationApiTests 16개 이식** — Ollama 시작 후 `tests/test_chatbot_integration.py` 작성. 원본 `apps/chatbot/tests.py:784-1798` 참조. `_enqueue_arq_job` mock 패턴은 `tests/test_automation_api.py`에 이미 구축됨
