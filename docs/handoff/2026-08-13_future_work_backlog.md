...
| P2 | Servc OOS 검증과 재학습 판단 | 유효 OOS **1,194건**(2026-08-14 실측). 2건은 백필 이전 낡은 수치 | 유효 3,098건 축적 뒤 현 Champion부터 평가. 약 14.0영업일 예상 |
...
2026-08-14 실측으로 갱신했습니다. 필터 통과 유효 OOS 는 **1,194건**이고 유입률은
영업일당 **136.0건**입니다. 잔여 1,904건은 약 **14.0영업일**(2026-09-04 전후)입니다.
