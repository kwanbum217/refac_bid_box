...
| 순서 | 작업 | 선행 조건 |
| :---: | --- | --- |
| 1 | ~~`128e93fe` CI 결과 확인~~ 전 잡 성공 | - |
| 2 | 고아 FULLTEXT 사전 항목 제거. 복제본 검증 완료, 남은 방법은 논리 덤프 복원 (6.3 절) | 사용자 결정, 컷오버·업그레이드 시점 권고 |
| 3 | 낙찰 금액 집계 커버링 인덱스 약 300MB (6.3 절). 고아 항목은 선행 조건 아님 | DDL 합의 |
