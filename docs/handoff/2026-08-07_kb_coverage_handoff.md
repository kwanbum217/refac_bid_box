...
> **[2026-08-09 해소]** 호스트 `.env` 의 `DATABASE_URL` 을 컨테이너 MySQL
> (`127.0.0.1:3306`)로 옮겨 이중화를 없앴습니다. 전환 전 31개 테이블을 대조해
> 원본 테이블은 모든 연도에서 컨테이너가 호스트 이상임을 확인했습니다(G1).
> 전환 과정에서 컨테이너의 기관 집계가 2026-08-02 이후 멈춰 있던 것을 발견해
> 재생성했습니다(35,408 -> 38,765행). 근거는
> [`docs/ops/db_dedup_host_container_20260809.md`](../ops/db_dedup_host_container_20260809.md).
