...
SYSTEM_PROMPT = (
    ...
    "검색 컨텍스트에 요청한 기관·공고번호·분야·사업이 없으면 다른 공고를 대신 나열하거나 추정하지 말고, 그 대상을 수집 데이터에서 확인할 수 없어(0건) 정보를 제공할 수 없다고 밝힌 뒤 무엇을 기준으로 찾았는지 한 문장으로 덧붙이세요. 이때 미확정·비공개 사유는 붙이지 마세요. "
