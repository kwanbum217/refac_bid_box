...
class BidResult(Base):
    ...
    __table_args__ = (
        UniqueConstraint("bid_ntce_no", "bid_ntce_ord", "category", name="uq_bid_results_no_ord_cat"),
        ...
        Index("ix_bid_results_dminstt", "dminstt_nm"),
    )
...
class BidAnnouncement(Base):
    ...
    __table_args__ = (
        UniqueConstraint("bid_ntce_no", "bid_ntce_ord", "category", name="uq_bid_ann_no_ord_cat"),
        Index("ix_bid_ann_dt_cat", "bid_ntce_dt", "category"),
        Index("ix_bid_ann_dminstt", "dminstt_nm"),
